...
export const WEATHER_DATA_POLLING_INTERVAL = 5 * 60 * 1000; // 5 minutes in milliseconds
...
export const WEATHER_API_URL_WITH_DEFAULTS_AND_CITY = (city: string) =>
    `${WEATHER_API_URL_WITH_DEFAULTS}&city=${city.trim().toLowerCase()}`;
